...
function ChangePasswordScreen({navigation}: NativeStackScreenProps<MyTabStackParamList>) {
    //user info
    ...
    const [checkPasswordMessageError, setCheckPasswordMessageError] = useState('');
    ...
    const isFormValid = () => {
        return (
            isPasswordMatch && isNewPasswordValid
        );
    };
    ...
    return (
        <View style={styles.root}>
            <View style={styles.formContainer}>
                ...
                <View style={styles.inputContainer}>
                    <BlackBasicButton buttonText={"Change Password"} isButtonActive={isFormValid()} title={"Change Password"} onClick={handleChangePasswordButtonClick}/>
                </View>
            </View>
        </View>
    );
